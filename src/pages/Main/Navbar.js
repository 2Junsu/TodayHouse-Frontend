      ...
      <NavbarContent>
        <NavListFront>
          ...
          <NavItem>
            <Link
              to="community"
              onMouseOver={() => changeNavSelect("community")}
            >
        ...
        <NavListBack>
          ...
          {isLogin ? ( //로그인 여부에 따른 조건부 렌더링
            <NavItem>
              <Menu
                onClick={() => dropDownOver("menuDropDown")}
                onMouseLeave={() => dropDownOut("menuDropDown")}
              >
                <MenuIcon src="https://img1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/7r5X/image/9djEiPBPMLu_IvCYyvRPwmZkM1g.jpg" />
              ...
              <Menu
                onClick={() => dropDownOver("writingDropDown")}
                onMouseLeave={() => dropDownOut("writingDropDown")}
              >
                <Writing>글쓰기</Writing>
            ...
            <>
              <NavItem>
                <NavItem>
                  <Link to="/login">
                    <NavText style={{ color: "grey", fontSize: "15px" }}>
                      로그인
                    </NavText>
                  </Link>
                </NavItem>
